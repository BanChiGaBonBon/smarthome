...
public class ManuScope
{
    public int manuid;

    public ManuScope(int manuid)
    {
        this.manuid = manuid;
    }
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                try
                {
                    ...
                    } else
                    {
                        ...
                        int more = query.queryequipmentdatamore(Integer.parseInt(id.getText().trim()), fromtime, totime, Double.parseDouble(val.getText().trim()), type,manuid);

                        int equal = query.queryequipmentdataequal(Integer.parseInt(id.getText().trim()), fromtime, totime, Double.parseDouble(val.getText().trim()), type,manuid);

                        int less = query.queryequipmentdataless(Integer.parseInt(id.getText().trim()), fromtime, totime, Double.parseDouble(val.getText().trim()), type,manuid);
    ...
    {
        ManuScope l = new ManuScope(300001);
        l.run();
    }
