...
public class DataDistribution
{
                ...
                try
                {
                    ...
                    } else
                    {
                        ...
                        if (comboBox.getSelectedIndex() == 1)
                        {
                            ...
                            int a = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 0.0f, 9.1f, "Temperature");
                            int b = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 9.1f, 18.2f, "Temperature");
                            int c = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 18.2f, 27.3f, "Temperature");
                            int d = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 27.3f, 36.4f, "Temperature");
                            int x = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 36.4f, 45.5f, "Temperature");
                        ...
                        } else if (comboBox.getSelectedIndex() == 2)
                        {
                            ...
                            int a = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 0.0f, 20.0f, "Humidity");
                            int b = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 20.0f, 40.0f, "Humidity");
                            int c = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 40.0f, 60.0f, "Humidity");
                            int d = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 60.0f, 80.0f, "Humidity");
                            int x = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 80.0f, 100.0f, "Humidity");
                            String type = comboBox.getSelectedItem().toString();
                        ...
                        } else if (comboBox.getSelectedIndex() == 3)
                        {
                            ...
                            String type = comboBox.getSelectedItem().toString();
                            int a = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 0.0f, 80.0f, "Brightness");
                            int b = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 80.0f, 135.0f, "Brightness");
                            int c = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 135.0f, 190.0f, "Brightness");
                            int d = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 190.0f, 245.0f, "Brightness");
                            int x = query.queryequipmentdatascope(Integer.parseInt(id.getText().trim()), fromtime, totime, 245.0f, 300.0f, "Brightness");
                        ...
                        } else if (comboBox.getSelectedIndex() == 4)
                        {
                            ...
                            String type = comboBox.getSelectedItem().toString();
                            int onvalue = query.queryequipmentdataequal(Integer.parseInt(id.getText().trim()), fromtime, totime, 0, "State of Door&Window");
                            int offvalue = query.queryequipmentdataequal(Integer.parseInt(id.getText().trim()), fromtime, totime, 1, "State of Door&Window");
    ...
    {
        DataDistribution l = new DataDistribution();
        l.run();
    }
