...
public class UserModify
{
    ...
    public UserModify(String a, String b, String c, String d)
    {
        run(a, b, c, d);
    }
    ...
    public void run(String column1, String column2, String column3, String column4)
    {
        ...
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 - 2, UIStyle.height / 2 - 250, "mid", Color.decode("#58606A"), Color.BLACK, "Modify User", 400, 100, BIG_FONT);
        testPanel.add(top);
        ...
        testPanel.add(g);
        InputText h = new InputText(200, 25, 11, true, UIStyle.width - 310, UIStyle.height / 2 / 2 + 230, "", true);
        testPanel.add(h);
        ...
        confirm.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                // TODO Auto-generated method stub
                if (x.getText().trim().isEmpty() || f.getText().trim().isEmpty() || g.getText().trim().isEmpty() || h.getText().trim().isEmpty())
                {
                ...
                {
                    remind.WRONG("user ID can not be changed");
                } else if (query.searchfamilyid(Integer.parseInt(h.getText().trim())) == 0)
                {
                    remind.WRONG("family ID not existed");

                } else
                {
                    int i = update.updateuser(Integer.parseInt(column1.trim()), f.getText().trim(), g.getText().trim(), Integer.parseInt(h.getText().trim()));
                    if (i == 1)
                    {
