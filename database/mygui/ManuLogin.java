...
import manufacturer.login;

public class ManuLogin
{
    ...
    public void run()
    {
        ...
        DynamicText id = new DynamicText(UIStyle.width / 2 - 160, UIStyle.height / 2 - 100, "right", Color.decode("#58606A"), Color.BLACK, "Manu ID:", 100, 100, NORMAL_FONT);
        testPanel.add(id);
        ...
        testPanel.add(pass);
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 + 50, UIStyle.height / 2 - 200, "mid", Color.decode("#58606A"), Color.BLACK, "Manufacturer Login", 400, 100, BIG_FONT);
        testPanel.add(top);
        ...
        log.addMouseListener(new MouseListener()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                } else
                {
                    ...
                    {
                        remind.OK("Login");
                        mygui.ManuOperation l = new mygui.ManuOperation(Integer.parseInt(in.getText()));
                        l.run();
                        jf.setVisible(false);
                    } else
                    {
