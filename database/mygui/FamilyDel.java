...
public class FamilyDel
{
    ...
    public void run()
    {
        ...
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 + 50, UIStyle.height / 2 - 250, "mid", Color.decode("#58606A"), Color.BLACK, "Delete Family", 400, 100, BIG_FONT);
        testPanel.add(top);
...
//	        t.getSelectionModel().setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
        ...
        find.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                {
                    //search by ID in db
                    String[][] v = query.queryfamilyid(Integer.parseInt(in.getText().trim()));
...
//                            }
                ...
                } else if (b.isSelected())
                {
                    ...
                    String[][] v = query.queryfamilyname(in.getText().trim());
                    //TableList t= new TableList(attribute,v, Color.BLACK, Color.WHITE, Color.decode("#F0F8FF"), UIStyle.width/2-485, UIStyle.height/2/2, UIStyle.width-10,UIStyle.height/2);
