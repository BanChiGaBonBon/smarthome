...
public class ManuMod
{
    ...
    public void run()
    {
        ...
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 + 50, UIStyle.height / 2 - 250, "mid", Color.decode("#58606A"), Color.BLACK, "Modify Equipment", 400, 100, BIG_FONT);
        testPanel.add(top);
        ...
        find.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                    ...
                    mod.addMouseListener(new MouseAdapter()
                    {
                        ...
                        public void mouseClicked(MouseEvent e)
                        {
                            ...
                            } else
                            {
                                ...
                                String gettype = t.getValueAt(rowIndex, 3).toString();
                                String getmanu = t.getValueAt(rowIndex, 4).toString();
                                String getfamily = t.getValueAt(rowIndex, 5).toString();
                                ManuModify u = new ManuModify(getid, getname, getpass, gettype, getmanu, getfamily);
                ...
                } else if (b.isSelected())
                {
                    ...
                    String[][] v = query.queryequipmentname(in.getText(),manuid);
                    DefaultTableModel model = new DefaultTableModel(v, attribute);
                    TableList t = new TableList(model, Color.BLACK, Color.WHITE, Color.decode("#F0F8FF"), UIStyle.width / 2 - 485, UIStyle.height / 2 / 2, UIStyle.width - 10, UIStyle.height / 2);
                    ...
                    mod.addMouseListener(new MouseAdapter()
                    {
                        ...
                        public void mouseClicked(MouseEvent e)
                        {
                            ...
                            } else
                            {
                                ...
                                String getmanu = t.getValueAt(rowIndex, 4).toString();
                                String getfamily = t.getValueAt(rowIndex, 5).toString();
                                EquipModify u = new EquipModify(getid, getname, getpass, gettype, getmanu, getfamily);
