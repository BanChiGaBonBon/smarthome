...
public class TypeDel {
	...
	public void run() {
        ...
        DynamicText top=new DynamicText(UIStyle.width / 2/2+50,UIStyle.height / 2-250,"mid",Color.decode("#58606A"),Color.BLACK,"Delete Category", 400,100, BIG_FONT);
        testPanel.add(top);	
  			 			...
  			 			public void mouseClicked(MouseEvent e) {
							...
							for (int i = 0; i < rowIndex.length; i++)
							{
								...
								} else
								{
									...
									String getid = t.getValueAt(rowIndex[i], 0).toString().trim();
									update.deletetype(getid);
