...
public class ManuFamily
{
	public int manuid;
	public ManuFamily(int manuid)
	{
		this.manuid=manuid;
	}
    public void run()
        ...
        gene.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                try
                {
                    ...
                    {
                        int []a= query.queryequipmentdatalessall(fromtime,totime,manuid);
                        int []b= query.queryequipmentdataequalall(fromtime,totime,manuid);
                        int []c= query.queryequipmentdatamoreall(fromtime,totime,manuid);
    ...
    {
        ManuFamily l = new ManuFamily(300001);
        l.run();
    }
