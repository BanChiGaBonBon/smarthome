...
public class EquipDel
{
    ...
    public void run()
    {
        ...
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 + 50, UIStyle.height / 2 - 250, "mid", Color.decode("#58606A"), Color.BLACK, "Delete Equipment", 400, 100, BIG_FONT);
        testPanel.add(top);
        ...
        find.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                } else if (b.isSelected())
                {
                    ...
                    String[][] v = query.queryequipmentname(in.getText().trim());
                    //TableList t= new TableList(attribute,v, Color.BLACK, Color.WHITE, Color.decode("#F0F8FF"), UIStyle.width/2-485, UIStyle.height/2/2, UIStyle.width-10,UIStyle.height/2);
