...
public class UserMod
{
    ...
    public void run()
    {
        ...
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 + 50, UIStyle.height / 2 - 250, "mid", Color.decode("#58606A"), Color.BLACK, "Modify User", 400, 100, BIG_FONT);
        testPanel.add(top);
...
//                                update.deleteuser(Integer.parseInt(t.getValueAt(rowIndex, 0).toString()));
                                UserModify u = new UserModify(getid, getname, getpass, getfamily);
                ...
                } else if (b.isSelected())
                {
                    ...
                    String[][] v = query.queryusername(in.getText());
                    DefaultTableModel model = new DefaultTableModel(v, attribute);
                    TableList t = new TableList(model, Color.BLACK, Color.WHITE, Color.decode("#F0F8FF"), UIStyle.width / 2 - 485, UIStyle.height / 2 / 2, UIStyle.width - 10, UIStyle.height / 2);
