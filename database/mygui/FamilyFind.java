...
public class FamilyFind
{
    ...
    public void run()
    {
        ...
        DynamicText top = new DynamicText(UIStyle.width / 2 / 2 + 50, UIStyle.height / 2 - 250, "mid", Color.decode("#58606A"), Color.BLACK, "Search Family", 400, 100, BIG_FONT);
        testPanel.add(top);
