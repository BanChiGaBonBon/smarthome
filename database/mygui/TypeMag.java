...
public class TypeMag {
	...
	public void run() {
        ...
        DynamicText top=new DynamicText(UIStyle.width / 2/2+50,UIStyle.height / 2-250,"mid",Color.decode("#58606A"),Color.BLACK,"Category Management", 400,100, BIG_FONT);
        testPanel.add(top);	
...
//        jf.getContentPane().add(roll);
        ...
        String[][] value= query.querytypeall();
