...
public class TypeFind {
	...
	public void run() {
        ...
        DynamicText top=new DynamicText(UIStyle.width / 2/2+50,UIStyle.height / 2-250,"mid",Color.decode("#58606A"),Color.BLACK,"Search Category", 400,100, BIG_FONT);
        testPanel.add(top);	
...
//        jf.getContentPane().add(roll);
        ...
        DynamicText type=new DynamicText(160,UIStyle.height / 2-183,"mid",Color.decode("#58606A"),Color.BLACK,"Please enter type name : ", 250,95, NORMAL_FONT);
        testPanel.add(type);	
