...
public class ManuModify
{

    public ManuModify(String a, String b, String c, String d, String x, String f)
    {
        run(a, b, c, d, x, f);
    }
    ...
    public void run(String column1, String column2, String column3, String column4, String column5, String column6)
    {
        ...
        confirm.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                // TODO Auto-generated method stub
                if (x.getText().isEmpty() || f.getText().isEmpty() || g.getText().isEmpty() || h.getText().isEmpty() )
                {
                ...
                {
                    int i = update.updateequipment(Integer.parseInt(column1.trim()), f.getText().trim(), g.getText().trim(), column4.trim(), Integer.parseInt(column5.trim()), Integer.parseInt(column6.trim()));
                    if (i == 1)
                    {
...
//{
//
//    public ManuModify(String a, String b, String c)
//    {
//        run(a, b, c);
//    }
//
...
//
//                // TODO Auto-generated method stub
//                if (x.getText().isEmpty() || f.getText().isEmpty() || g.getText().isEmpty())
//                {
//                    remind.WRONG("Please fill in the blank.");
//                } else if (x.getText().equals("1111"))//check if there's duplicate ID in db
//                {
