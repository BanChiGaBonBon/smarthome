 ...
 * @version 5.3
 */
public class TableTool extends JTable
{
    public JPopupMenu popmenu;
    public int focusedRowIndex;
    public TableTool(String[] columnNames, String[][] tableValues, Color textColor, Color backgroundColor, Color selectionColor, int x, int y, int width, int height)
    {
